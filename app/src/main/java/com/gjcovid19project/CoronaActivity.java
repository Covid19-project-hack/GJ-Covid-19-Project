...
import com.gjcovid19project.Adapter.CoronaAdapter;
import com.gjcovid19project.Adapter.FAQAdapter;
import com.gjcovid19project.Models.Corona;
import com.gjcovid19project.Models.FAQ;
import com.gjcovid19project.Models.Persons;
        ...
        JsonObjectRequest request1 = new JsonObjectRequest(Request.Method.GET,url1, null,
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                            JSONObject jsonObject = response.getJSONObject("Gujarat").getJSONObject("districtData");
